import { r as reactExports, R as React2, b as ReactDOM, a as reactDomExports } from "./react-vendor-Bhf2bzcN.js";
...
(function(exports) {
  ...
  var r2 = [], t = [], u = 1, v2 = null, y = 3, z = false, A = false, B = false, D2 = "function" === typeof setTimeout ? setTimeout : null, E2 = "function" === typeof clearTimeout ? clearTimeout : null, F = "undefined" !== typeof setImmediate ? setImmediate : null;
  ...
  exports.unstable_scheduleCallback = function(a, b, c) {
    ...
    c > d ? (a.sortIndex = c, f(t, a), null === h(r2) && a === h(t) && (B ? (E2(L2), L2 = -1) : B = true, K(H, c - d))) : (a.sortIndex = e, f(r2, a), A || z || (A = true, I(J)));
    return a;
  };
...
var ve = (n) => {
  ...
  let { invert: e, toast: t, unstyled: a, interacting: u, setHeights: f, visibleToasts: w, heights: S, index: g, toasts: i, expanded: D2, removeToast: T, defaultRichColors: F, closeButton: et, style: ut, cancelButtonStyle: ft, actionButtonStyle: l, className: ot = "", descriptionClassName: at = "", duration: X, position: st, gap: pt, loadingIcon: rt, expandByDefault: B, classNames: s, icons: P2, closeButtonAriaLabel: nt = "Close toast", pauseWhenPageIsHidden: it } = n, [Y, C] = React2.useState(null), [lt, J] = React2.useState(null), [W, H] = React2.useState(false), [A, mt] = React2.useState(false), [L2, z] = React2.useState(false), [ct, d] = React2.useState(false), [h, y] = React2.useState(false), [R, j2] = React2.useState(0), [p, _] = React2.useState(0), O = React2.useRef(t.duration || X || Wt), G = React2.useRef(null), k = React2.useRef(null), Vt = g === 0, Ut = g + 1 <= w, N = t.type, V = t.dismissible !== false, Kt = t.className || "", Xt = t.descriptionClassName || "", dt = React2.useMemo(() => S.findIndex((r2) => r2.toastId === t.id) || 0, [S, t.id]), Jt = React2.useMemo(() => {
    var r2;
    return (r2 = t.closeButton) != null ? r2 : et;
  }, [t.closeButton, et]), Tt = React2.useMemo(() => t.duration || X || Wt, [t.duration, X]), gt = React2.useRef(0), U = React2.useRef(0), St = React2.useRef(0), K = React2.useRef(null), [Gt, Qt] = st.split("-"), Rt = React2.useMemo(() => S.reduce((r2, m, c) => c >= dt ? r2 : r2 + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N === "loading";
  ...
  let $ = React2.useCallback(() => {
    mt(true), j2(U.current), f((r2) => r2.filter((m) => m.toastId !== t.id)), setTimeout(() => {
      T(t);
    }, we);
  }, [t, T, f, U]);
  React2.useEffect(() => {
  ...
  }, [D2, u, t, N, it, Et, $]), React2.useEffect(() => {
    t.delete && $();
  }, [$, t.delete]);
  function Zt() {
    var r2, m, c;
    return P2 != null && P2.loading ? React2.createElement("div", { className: M(s == null ? void 0 : s.loader, (r2 = t == null ? void 0 : t.classNames) == null ? void 0 : r2.loader, "sonner-loader"), "data-visible": N === "loading" }, P2.loading) : rt ? React2.createElement("div", { className: M(s == null ? void 0 : s.loader, (m = t == null ? void 0 : t.classNames) == null ? void 0 : m.loader, "sonner-loader"), "data-visible": N === "loading" }, rt) : React2.createElement(Yt, { className: M(s == null ? void 0 : s.loader, (c = t == null ? void 0 : t.classNames) == null ? void 0 : c.loader), visible: N === "loading" });
  }
  return React2.createElement("li", { tabIndex: 0, ref: k, className: M(ot, Kt, s == null ? void 0 : s.toast, (Dt = t == null ? void 0 : t.classNames) == null ? void 0 : Dt.toast, s == null ? void 0 : s.default, s == null ? void 0 : s[N], (Pt = t == null ? void 0 : t.classNames) == null ? void 0 : Pt[N]), "data-sonner-toast": "", "data-rich-colors": (Nt = t.richColors) != null ? Nt : F, "data-styled": !(t.jsx || t.unstyled || a), "data-mounted": W, "data-promise": !!t.promise, "data-swiped": h, "data-removed": A, "data-visible": Ut, "data-y-position": Gt, "data-x-position": Qt, "data-index": g, "data-front": Vt, "data-swiping": L2, "data-dismissible": V, "data-type": N, "data-invert": qt, "data-swipe-out": ct, "data-swipe-direction": lt, "data-expanded": !!(D2 || B && W), style: { "--index": g, "--toasts-before": g, "--z-index": i.length - g, "--offset": `${A ? R : U.current}px`, "--initial-height": B ? "auto" : `${p}px`, ...ut, ...t.style }, onDragEnd: () => {
    ...
    if (Math.abs(b) >= ye || I > 0.11) {
      j2(U.current), (Z = t.onDismiss) == null || Z.call(t, t), J(Y === "x" ? r2 > 0 ? "right" : "left" : m > 0 ? "down" : "up"), $(), d(true), y(false);
      return;
    }
    z(false), C(null);
  }, onPointerMove: (r2) => {
...
var $e = reactExports.forwardRef(function(e, t) {
  ...
  return React2.useEffect(() => v.subscribe((d) => {
    ...
    var j2;
    let [y, R] = d.split("-");
    return B.length ? React2.createElement("ol", { key: d, dir: ot === "auto" ? _t() : ot, tabIndex: -1, ref: A, className: g, "data-sonner-toaster": true, "data-theme": W, "data-y-position": y, "data-lifted": Y && B.length > 1 && !w, "data-x-position": R, style: { "--front-toast-height": `${((j2 = nt[0]) == null ? void 0 : j2.height) || 0}px`, "--width": `${he}px`, "--gap": `${at}px`, ...ut, ...Te(i, D2) }, onBlur: (p) => {
...
export {
  $e as $,
  useParams as A,
  NavigationContext as N,
  ReactRemoveScroll as R,
  autoUpdate as a,
  size as b,
  arrow as c,
  hideOthers as d,
  schedulerExports as e,
  flip as f,
  stripBasename as g,
  hide as h,
  useHref as i,
  ...
  useLocation as k,
  limitShift as l,
  useResolvedPath as m,
  createPath as n,
  offset as o,
  createBrowserHistory as p,
  logV6DeprecationWarnings as q,
  Router as r,
  shift as s,
  j as t,
  useFloating as u,
