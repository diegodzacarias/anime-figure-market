...
const NINNIN_GAME_SCRAPING_ENDPOINT = `${BASE_URL}/v1/scraping/ninnin-game/search`;
async function runNinNinGameScraping(figureId) {
  const response = await fetch(`${NINNIN_GAME_SCRAPING_ENDPOINT}/${figureId}`, {
    method: "POST"
  });
  if (!response.ok) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container py-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid gap-6 xl:grid-cols-[minmax(24rem,0.85fr)_minmax(0,1.45fr)]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingOverlay, { active: running, message: "Running Nin-Nin Game scraping...", children: /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "space-y-6", children: !selectedFigure ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-[28rem] items-center justify-center rounded-lg border border-dashed bg-card p-8 text-center text-sm text-muted-foreground", children: "Select a figure to inspect scraping queries and run the manual scraper." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
