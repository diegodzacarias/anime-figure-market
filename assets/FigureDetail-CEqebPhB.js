import { c as createLucideIcon, j as jsxRuntimeExports, b as cn, d as cva, a as useParams, u as useNavigate, r as reactExports } from "./index-DjNhWZNZ.js";
import { b as withPagination, N as Navbar, B as Button, g as getPageContent } from "./page-IXUKuqvC.js";
import { A as ApiErrorToast, L as LoaderCircle, r as readApiErrorResponse, t as toClientApiError } from "./apiError-BAH6T2KL.js";
import { A as ArrowLeft } from "./arrow-left-B6RJGlIO.js";
/**
...
const getAvailabilityRank = (value) => {
...
const sortListingsByUsefulness = (listings) => [...listings].sort((a, b) => {
  const availabilityDiff = getAvailabilityRank(a.isAvailable) - getAvailabilityRank(b.isAvailable);
  if (availabilityDiff !== 0) return availabilityDiff;
  const aHasPrice = a.price !== void 0 && a.price !== null;
  const bHasPrice = b.price !== void 0 && b.price !== null;
...
const FigureDetail = () => {
  ...
  const sortedListings = reactExports.useMemo(() => sortListingsByUsefulness(listings), [listings]);
  const featuredListings = reactExports.useMemo(
    () => sortedListings.slice(0, MAX_FEATURED_LISTINGS),
    [sortedListings]
  );
  const hasMoreListings = listings.length > MAX_FEATURED_LISTINGS;
      ...
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-[24rem] items-center justify-center rounded-lg border bg-card text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(22rem,0.9fr)] lg:items-start", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-lg border bg-card p-5 shadow-card lg:sticky lg:top-24", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-foreground", children: "Mejores opciones" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: listings.length > 0 ? `Mostrando ${featuredListings.length} de ${listings.length} sources.` : "Datos registrados por tienda o fuente para esta figura." })
              ] }),
              listings.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: listings.length })
            ] }) }),
            featuredListings.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-dashed p-8 text-center text-sm text-muted-foreground", children: "No hay sources ni precios registrados para esta figura." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: featuredListings.map((listing) => /* @__PURE__ */ jsxRuntimeExports.jsx(SourceListingCard, { listing, compact: true }, listing.id)) }),
            hasMoreListings && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                type: "button",
                variant: "outline",
        ...
        hasMoreListings && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { ref: allSourcesRef, className: "mt-10 rounded-lg border bg-card p-5 shadow-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-foreground", children: "Comparar todas las fuentes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Todas las fuentes registradas para esta figura, ordenadas por disponibilidad y precio." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 lg:grid-cols-2", children: sortedListings.map((listing) => /* @__PURE__ */ jsxRuntimeExports.jsx(SourceListingCard, { listing }, listing.id)) })
        ] })
      ] })
    ] })
  ] });
